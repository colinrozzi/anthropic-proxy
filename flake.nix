{
  description = "anthropic-proxy - A Theater actor";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            echo "Looking for: ./target/wasm32-unknown-unknown/release/$(echo anthropic-proxy | tr '-' '_').wasm"
            echo "LS: $(ls ./target/wasm32-unknown-unknown/release)"
            SOURCE_FILE="./target/wasm32-unknown-unknown/release/$(echo anthropic-proxy | tr '-' '_').wasm"
            cp $SOURCE_FILE $out/lib/anthropic-proxy.wasm
          '';
